...
import { Article, CategoryId, DifficultyLevel } from "../types";
import { CATEGORIES_CONFIG } from "../data/mockDatabase";

interface ArticleFormModalProps {
  article: Article | null; // If null, mode is "create"
  isOpen: boolean;
  onClose: () => void;
...
export const ArticleFormModal: React.FC<ArticleFormModalProps> = ({
  ...
  const [category, setCategory] = useState<CategoryId>("web-dev");
  ...
  useEffect(() => {
    if (article) {
      ...
      setCategory(article.category || "web-dev");
